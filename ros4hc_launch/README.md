...
This directory contains example configuration and launch files for the ros4hc system. These examples are designed to help you get started with creating your own launch configs and parameter files.

## Directory Structure

- **`ros4hc_launch/config`**: Contains example configuration files such as `params.yaml`. Use these files as a reference to create your own configuration files.
- **`ros4hc_launch/launch`**: Contains example launch files such as `launch.py`. This file demonstrates how to start nodes and apply configurations.
